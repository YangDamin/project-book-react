  ...
  return (
    <div>
      <nav class="bg-white navbar navbar-expand-lg navbar-light py-lg-1">
        <div className="container"><a class="navbar-brand text-dark" href="/" target="_pg_blank">HANBOOK</a>
          <ul class="flex-row ms-auto navbar-nav order-lg-1 ps-2 pe-2">
            <li class="nav-item"> <a class="nav-link p-2 pb-3 ps-2 pe-2 pt-3 text-dark" href="#" title="Search"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="2em" height="2em">
              <g>
            ...
            <li class="nav-item"> <a class="nav-link p-2 pb-3 ps-2 pe-2 pt-3 text-dark" href="#" title="View Cart"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="2em" height="2em">
              <g>
                <path fill="none" d="M0 0h24v24H0z"></path>
                <path d="M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15.5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H.5a.5.5 0 0 1-.5-.5v-1A.5.5 0 0 1 .5 6h1.717L5.07 1.243a.5.5 0 0 1 .686-.172zM3.394 15l-1.48-6h-.97l1.525 6.426a.75.75 0 0 0 .729.574h9.606a.75.75 0 0 0 .73-.574L15.056 9h-.972l-1.479 6h-9.21z" />
              </g>
            </svg> <span class="small text-dark">(0)</span> 장바구니</a>
            </li>
